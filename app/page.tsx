...
export default function Home() {
  ...
  const parseStatNumber = (s: string) => {
    // Simple parser: convert compact forms into full numeric targets and return trailing suffix
    // Examples: "10K+" -> { value: 10000, suffix: '+' }
    ...
    if (scaleChar) {
      if (scaleChar.toUpperCase() === "K") value = value * 1000;
      if (scaleChar.toUpperCase() === "M") value = value * 1000000;
    }
    return { value, suffix: trailing };
  };
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-red-900 via-black to-red-900 text-white overflow-x-hidden scrollbar-hide">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 bg-gradient-to-b from-black via-red-900/20 to-black">
        ...
        <div className="container relative z-10 mx-auto text-center max-w-6xl py-20">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-12 text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
            Create magical karaoke moments with friends across the globe.
            Real-time sync, crystal-clear voice chat, and millions of songs at
            your fingertips.
          </p>
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="flex flex-col items-center mb-2 sm:mb-3">
                  ...
                  <span className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent inline-flex items-baseline justify-center">
                    {(() => {
      ...
      <section
        id="room-section"
        className="min-h-screen flex items-center py-16 sm:py-20 bg-gradient-to-b from-black via-gray-900/50 to-black backdrop-blur-sm px-4 sm:px-6 relative"
      >
        <div className="my-8 absolute top-0 flex w-full justify-center z-20">
          <MarqueeBanner />
        </div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10 w-full">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed px-4">
              Create a private room or join an existing one. It takes less than
      ...
      <section
        id="features"
        className="min-h-screen flex items-center py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-black via-red-900/10 to-black relative"
      >
        ...
        <div className="container mx-auto max-w-7xl relative z-10 w-full">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
              We&apos;ve built the most advanced online karaoke platform with
              features that make singing together feel natural and fun.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="p-5 sm:p-6 lg:p-8 bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-red-500/20 hover:border-red-500/40 transition-all duration-300 group backdrop-blur-sm relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="relative z-10">
                  <feature.icon
                    className={`w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 ${feature.color} mb-3 sm:mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300`}
                  />
                  <h3 className="text-base sm:text-lg lg:text-xl font-bold mb-2 sm:mb-3 lg:mb-4 text-white">
                    {feature.title}
                  </h3>
      ...
      >
        ...
        <div className="container mx-auto max-w-6xl relative z-10 w-full">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed px-4">
              Getting started with KaraCoro is incredibly simple. Follow these
              three easy steps.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Create a new room or join an existing one with a 6-character room code. Share the code with friends.",
                  icon: Users,
                },
                {
                  step: "2",
                  title: "Add Songs",
                  description:
                    "Search for your favorite karaoke songs on YouTube and add them to the queue. Everyone can contribute!",
                  icon: Music,
                },
                {
                  step: "3",
                  title: "Sing Together",
                  description:
                    "Take turns singing while everyone watches in perfect sync. Chat, cheer, and have amazing fun!",
                  icon: Mic,
                },
              ].map((item, index) => (
                <div key={index} className="text-center group">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-white px-4">
                    {item.title}
                  </h3>
      ...
      <section className="min-h-screen flex items-center py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-black via-red-900/10 to-black relative">
        ...
        <div className="container mx-auto max-w-6xl relative z-10 w-full">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed px-4">
              Join thousands of happy singers who&apos;ve made KaraCoro their
              go-to karaoke platform.
            </p>
          </div>
      ...
      <section className="min-h-screen flex items-center py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-red-600 via-red-700 to-red-800 relative overflow-hidden">
        ...
        <div className="container px-4 sm:px-6 mx-auto text-center max-w-4xl relative z-10">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-red-100 mb-8 sm:mb-10 lg:mb-12 leading-relaxed max-w-3xl mx-auto px-4 drop-shadow">
            Join the KaraCoro community today. It&apos;s completely free, works
            in any browser, and brings people together through the power of
            music.
          </p>
